...
import { addDays, format, set, setDay, setHours, setMinutes } from "date-fns";
                        ...
                        <div className="flex items-center justify-between mt-3">
                            ...
                            <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                                ...
                                <SheetContent className="p-0">
                                    ...
                                    <div className="py-6" >
                                        <Calendar mode="single" selected={date} onSelect={handleDateClick} locale={ptBR} fromDate={new Date()} toDate={new Date(new Date().setDate(new Date().getDate() + 30))}
                                            styles={{
